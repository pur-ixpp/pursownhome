      ...
      <div class="nav-side" ref="navSide">
        <ul>
          ...
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">京东超市</span> /
            <span class="nav-side-item">休闲零食</span> /
            <span class="nav-side-item">生鲜</span>/
            <span class="nav-side-item">水饮茗茶</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">男装</span> /
            <span class="nav-side-item">当季热卖</span> /
            <span class="nav-side-item">羽绒服</span> /
            <span class="nav-side-item">夹克</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">奢侈品</span> /
            <span class="nav-side-item">PRADA</span> /
            <span class="nav-side-item">PINKO</span> /
            <span class="nav-side-item">CANALI</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">女鞋</span> /
            <span class="nav-side-item">连衣裙</span> /
            <span class="nav-side-item">上衣</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">鞋靴</span> /
            <span class="nav-side-item">休闲鞋</span> /
            <span class="nav-side-item">运动鞋</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">内衣配饰</span> /
            <span class="nav-side-item">睡衣居家服</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">箱包</span> /
            <span class="nav-side-item">电脑包</span> /
            <span class="nav-side-item">拉杆箱</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">美妆护肤</span> /
            <span class="nav-side-item">美白</span> /
            <span class="nav-side-item">防晒</span>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <span class="nav-side-item">个护清洁</span> /
            <span class="nav-side-item">免洗洗手液</span>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <span class="nav-side-item">钟表珠宝</span> /
            <span class="nav-side-item">时尚饰品</span> /
            <span class="nav-side-item">黄金</span> /
